        ...
        <div className="maindiv">
         <div className="subdic">
           ...
           <div className="k3">
            ...
            <TextField className="k4" label="Email or phone" variant="outlined" />
            <span className="k5">
                <Button variant="text">Forgot email?</Button>
            </span>
           </div>
           <div className="k6">
            {/* <input className="k7" type="textfield" value={"Password"}/> */}
             <TextField className="k7" label="Password" variant="outlined" />
            <span className="k8">
